...
return!D.isUndefined(e[t])});let n=r.metaTokens,o=r.visitor||l,i=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,f=a&&D.isSpecCompliantForm(e);if(!D.isFunction(o))throw TypeError("visitor must be a function");function u(t){if(null===t)return"";if(D.isDate(t))return t.toISOString();if(!f&&D.isBlob(t))throw new M("Blob is not supported. Use a Buffer instead.");return D.isArrayBuffer(t)||D.isTypedArray(t)?f&&"function"==typeof Blob?new Blob([t]):X.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
 ...
 */function(t){if(D.isFormData(t)&&D.isFunction(t.entries)){let e={};return D.forEachEntry(t,(t,r)=>{!function t(e,r,n,o){let i=e[o++],s=Number.isFinite(+i),a=o>=e.length;if(i=!i&&D.isArray(n)?n.length:i,a)return D.hasOwnProp(n,i)?n[i]=[n[i],r]:n[i]=r,!s;n[i]&&D.isObject(n[i])||(n[i]=[]);let f=t(e,r,n[i],o);return f&&D.isArray(n[i])&&(n[i]=/**
 * Convert an array to an object.
 *
 * @param {Array<any>} arr - The array to convert to an object.
 *
 * @returns An object with the same keys and values as the array.
 */function(t){let e,r;let n={},o=Object.keys(t),i=o.length;for(e=0;e<i;e++)n[r=o[e]]=t[r];return n}(n[i])),!s}(D.matchAll(/\w+|\[(\w*)]/g,t).map(t=>"[]"===t[0]?"":t[1]||t[0]),r,e,0)}),e}return null};const tY={transitional:tq,adapter:["xhr","http"],transformRequest:[function(t,e){let r;let n=e.getContentType()||"",o=n.indexOf("application/json")>-1,i=D.isObject(t);i&&D.isHTMLForm(t)&&(t=new FormData(t));let s=D.isFormData(t);if(s)return o&&o?JSON.stringify(tG(t)):t;if(D.isArrayBuffer(t)||D.isBuffer(t)||D.isStream(t)||D.isFile(t)||D.isBlob(t))return t;if(D.isArrayBufferView(t))return t.buffer;if(D.isURLSearchParams(t))return e.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();if(i){if(n.indexOf("application/x-www-form-urlencoded")>-1){var a,f;return(a=t,f=this.formSerializer,t_(a,new tK.classes.URLSearchParams,Object.assign({visitor:function(t,e,r,n){return tK.isNode&&D.isBuffer(t)?(this.append(e,t.toString("base64")),!1):n.defaultVisitor.apply(this,arguments)}},f))).toString()}if((r=D.isFileList(t))||n.indexOf("multipart/form-data")>-1){let e=this.env&&this.env.FormData;return t_(r?{"files[]":t}:t,e&&new e,this.formSerializer)}}return i||o?(e.setContentType("application/json",!1),/**
...
return{get:()=>t,set(t){this[r]=t}}}),D.freezeMethods(t5),D.inherits(t3,M,{__CANCEL__:!0});var t7=tK.isStandardBrowserEnv?{write:function(t,e,r,n,o,i){let s=[];s.push(t+"="+encodeURIComponent(e)),D.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),D.isString(n)&&s.push("path="+n),D.isString(o)&&s.push("domain="+o),!0===i&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function t9(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var et=tK.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
void 0===i&&s.setContentType(null),"setRequestHeader"in u&&D.forEach(s.toJSON(),function(t,e){u.setRequestHeader(e,t)}),D.isUndefined(t.withCredentials)||(u.withCredentials=!!t.withCredentials),a&&"json"!==a&&(u.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&u.addEventListener("progress",er(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&u.upload&&u.upload.addEventListener("progress",er(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
...
eA.CanceledError=t3,eA.CancelToken=eE,eA.isCancel=t4,eA.VERSION=ep,eA.toFormData=t_,// Expose AxiosError class
...
eA.isAxiosError=function(t){return D.isObject(t)&&!0===t.isAxiosError},// Expose mergeConfig
eA.mergeConfig=eh,eA.AxiosHeaders=t5,eA.formToJSON=t=>tG(D.isHTMLForm(t)?new FormData(t):t),eA.getAdapter=ef.getAdapter,eA.HttpStatusCode=ew,eA.default=eA;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
const{Axios:eO,AxiosError:eR,CanceledError:eB,isCancel:ev,CancelToken:eS,VERSION:eT,all:eU,Cancel:eC,isAxiosError:eI,spread:ex,toFormData:eN,AxiosHeaders:eL,HttpStatusCode:ej,formToJSON:e_,getAdapter:eP,mergeConfig:eF}=eA;eA.defaults.headers.common["x-api-key"]="live_1OhZbgVCeksHG2elZQfmONRKYCU8MoSXF8s1Kd7jNHbyFE8A5Y5sXWRCz2OxkYgS";const ek=t=>{let e=`https://api.thecatapi.com/v1/images/search?breed_ids=${t}`;return eA.get(e).then(t=>{if(!t.ok)return t.data;throw Error(`Кот не найден (${t.status})`)})},eD={selectEl:document.querySelector(".breed-select"),catInfoEl:document.querySelector(".cat-info"),loaderEl:document.querySelector(".loader"),errorEl:document.querySelector(".error")};function eM(){eD.loaderEl.style.display="block",eD.selectEl.style.display="none",eD.catInfoEl.style.display="none"}function e$(){eD.loaderEl.style.display="none",eD.selectEl.style.display="block",eD.catInfoEl.style.display="block"}function eq(t){eD.errorEl.textContent=t}function ez(){eD.errorEl.textContent=""}ez(),eM(),eA.get("https://api.thecatapi.com/v1/breeds").then(t=>{if(!t.ok)return t.data;throw Error(`Кот не найден (${t.status})`)}).then(t=>{if(t)t.forEach(t=>{let e=document.createElement("option");e.value=t.id,e.textContent=t.name,eD.selectEl.appendChild(e)});else throw Error("Кот не найден");e$()}).catch(t=>{eq(t.message),e$()}),eD.selectEl.addEventListener("change",t=>{let e=t.target.value;ez(),eM(),ek(e).then(t=>{if(t){let e=t[0].url,r=t[0].breeds[0].name,n=t[0].breeds[0].description,o=`<img src="${e}" height=400 width="600"/>
         <h2 class="cats-name">${r}</h2> <p>${n}</p>`;eD.catInfoEl.innerHTML=o}else throw Error("Кот не найден");e$()}).catch(t=>{eq(t.message),e$()})});//# sourceMappingURL=index.d6bc96b3.js.map

//# sourceMappingURL=index.d6bc96b3.js.map
